...
if (false) {
    ...
    class XFCP_ThemeHouse_GroupBbCodes_Extend_XenForo_BbCode_Formatter_Text extends XenForo_BbCode_Formatter_Text
    {
    }
}

class ThemeHouse_GroupBbCodes_Extend_XenForo_BbCode_Formatter_Text extends XFCP_ThemeHouse_GroupBbCodes_Extend_XenForo_BbCode_Formatter_Text
{

    public function __construct()
    {
        $this->_advancedReplacements = array_merge($this->_advancedReplacements,
            array(
